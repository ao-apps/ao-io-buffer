 ...
 *
 * <p>All implementations are thread safe.</p>
 *
 * <p>Idea: Add contentEquals(String) method to avoid some uses of toString?</p>
 *
 * @see  BufferWriter
 *
...
public interface BufferResult extends Writable {
   ...
   *
   * <p>All implementations cache the result for constant-time secondary access.</p>
   */
  @Override
