 ...
 * Copyright (C) 2013, 2014, 2015, 2016, 2019, 2020, 2021, 2022, 2024  AO Industries, Inc.
 ...
 *
 * <p>Future: If writing to another segmented buffer, the segments could be shared between
 * the two instances. (or arraycopy instead of writing each)</p>
 *
